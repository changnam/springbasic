package com.honsoft.springbasic.config;
...
@MapperScan(value = {"com.honsoft.springbasic.mapper.h2" }, sqlSessionFactoryRef = "h2SqlSessionFactory", nameGenerator = UniqueNameGenerator.class)
	 ...
	 @Bean(name="h2TestDB")
	  public DataSource dataSource() {
	    return new EmbeddedDatabaseBuilder()
	      ...
	      //.addDefaultScripts()
	      .addScript("ddl/h2/embeded/schema-h2.sql")
	      .addScript("ddl/h2/embeded/data-h2.sql")
